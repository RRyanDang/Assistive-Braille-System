...
# this rate is taken from k64f - update if necessary
SAMPLE_RATE = 12751 #Hz

# set up parameter for Whisper model
OCR_LANGUAGES = ['en'] # english
WHISPER_MODEL = "base" # base is enough

# EasyOCR returns 0.0–1.0 per word. It averages all words.
...
# making sure everything is loaded 1st time when using
...
# SQLITE codes are developed with the assistance of Claude
# from 84 - 205
...
# this func (249 - 269) is generated by Claude and validated by developers
...
def transcribe_audio(float_samples):
    ...
    """
    try: # in case it has unexptected output, catch error
...
# simple address to test connection
@app.route("/test", methods=["GET"])
def test():
    print("[GET /test] Ping received")
    return "OK", 200

# this route (321 - 335) is generated by Claude and validated by developers
...
# partical of this code is assisted by Claude and written by developers
...
# this section (509 - 541) is developed with the assistance of ChatGPT
...
# this HTML UI is generated by Claude (548 - 980)
@app.route("/")
def dashboard():
...
# Claude is used to help validating and confirming systax of the written code below
